...
def multVectorxEscalar(vec1, escalar):
    respuesta = []
    for x in range(len(vec1)):
        res = vec1[x] * escalar
        respuesta.append(res)
...
def sumVectorxEscalar(vec1, escalar):
    respuesta = []
    for x in range(len(vec1)):
        res = vec1[x] + escalar
        respuesta.append(res)
...
def divisionVectorxEscalar(vec1, escalar):
    respuesta = []
    for x in range(len(vec1)):
        res = vec1[x] / escalar
        respuesta.append(res)
...
def restaVectorxEscalar(vec1, escalar):
    respuesta = []
    for x in range(len(vec1)):
        res = vec1[x] - escalar
        respuesta.append(res)
